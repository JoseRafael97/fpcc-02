...
Outra coisa: os 4 primeiros notebooks em https://github.com/nazareno/fpcc2/tree/master/03-inferencia são sobre intervalos de confiança e bootstrap. E tem código. Tem também vários links de livros online no canvas. Na medida que precisar, revise lá.
...
# sim inclui poderia não ter incluído, no entanto com média 95% ela está dentro, logo esse comportamento era esperado
...
diferencas = tibble(dif = as.double(bootstraps$t) - median(uma_amostra$tempo_no_site))
