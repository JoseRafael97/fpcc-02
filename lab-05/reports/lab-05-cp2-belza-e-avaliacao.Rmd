...
Analisando a Figura 6, é idetificável a exisência de um pequeno aumento no score quando a média da beleza dos professores aumenta. Para verificar com mais detalhes esta relação, foi utilizada regressõa simples e abaixo são apresentados os resultados obtidos com esta técnica.  
...
Com base nesses, resultados é possível concluir que apesar da beleza conseguir explicar 3% da variável score (hipótese confirmada), outras apresentaram um imapcto maior nesse aspecto. Assim, de acordo com os resultados devem existir aspectos que apresentam maior impacto no score do professor do quê sua beleza. 